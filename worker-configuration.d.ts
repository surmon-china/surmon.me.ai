/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4e129a7c2bd031c0ea1f7387aa60a7d4)
// Runtime types generated with workerd@1.20260310.1 2026-03-01 
declare namespace Cloudflare {
	...
	interface Env {
		RAG_BUCKET: R2Bucket;
		AGENT_DB: D1Database;
		AI_TOKEN_RATE_LIMITER: RateLimit;
		AI_CHAT_RATE_LIMITER: RateLimit;
		AI: Ai;
		CF_AI_GATEWAY_ID: "surmon-me-ai";
		CF_AI_SEARCH_INSTANCE_NAME: "surmon-me-rag";
		CF_AIG_TOKEN: string;
		CF_ACCOUNT_ID: string;
		WEBHOOK_SECRET: string;
		CHAT_TOKEN_SECRET: string;
		CHAT_API_CORS_ORIGIN: string;
		ADMIN_API_CORS_ORIGIN: string;
		ADMIN_API_VERIFY_TOKEN_ENDPOINT: string;
	}
}
